...
<section class="mx-[15%]">
    <div class="text-white p-10">
        <h1 class="md:text-5xl text-3xl my-10">Envoyer mon Dessin</h1>
        <p class="md:text-2xl text-lg my-10">Pour envoyer votre dessin, veuillez créer un compte et remplir le formulaire ci-dessous</p>
    </div>
    <div>
