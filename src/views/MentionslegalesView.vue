<template>
        ...
        <p class="my-2 text-white mx-20">Contenu : Ensemble des éléments constituants l’information présente sur le Site, notamment textes – images – vidéos.</p>

        <p class="my-2 text-white mx-20">Informations clients : Ci après dénommé « Information (s) » qui correspondent à l’ensemble des données personnelles susceptibles d’être détenues par <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a> pour la gestion de votre compte, de la gestion de la relation client et à des fins d’analyses et de statistiques.</p>

        <p class="my-2 text-white mx-20">Utilisateur : Internaute se connectant, utilisant le site susnommé.</p>

        <p class="my-2 text-white mx-20">Informations personnelles : « Les informations qui permettent, sous quelque forme que ce soit, directement ou non, l'identification des personnes physiques auxquelles elles s'appliquent » (article 4 de la loi n° 78-17 du 6 janvier 1978).</p>

        <p class="my-2 text-white mx-20">Les termes « données à caractère personnel », « personne concernée », « sous traitant » et « données sensibles » ont le sens défini par le Règlement Général sur la Protection des Données (RGPD : n° 2016-679)</p>

        <h2 class="my-6 text-white font-semibold mx-16 text-lg">1. Présentation du site internet </h2>

        <p class="my-2 text-white mx-20">En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans l'économie numérique, il est précisé aux utilisateurs du site internet <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a> l'identité des différents intervenants dans le cadre de sa réalisation et de son suivi:</p>

        <p class="my-2 text-white mx-20">Propriétaire : Département MMi – 4, place Tharradin 25 200 Montbéliard
        ...
        <p class="my-2 text-white mx-20">L’utilisation du site <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a> implique l’acceptation pleine et entière des conditions générales d’utilisation ci-après décrites. Ces conditions d’utilisation sont susceptibles d’être modifiées ou complétées à tout moment, les utilisateurs du site <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a> sont donc invités à les consulter de manière régulière.</p>

        <p class="my-2 text-white mx-20">Ce site internet est normalement accessible à tout moment aux utilisateurs. Une interruption pour raison de maintenance technique peut être toutefois décidée par <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a>, qui s’efforcera alors de communiquer préalablement aux utilisateurs les dates et heures de l’intervention. Le site web <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a> est mis à jour régulièrement par <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a> responsable. De la même façon, les mentions légales peuvent être modifiées à tout moment : elles s’imposent néanmoins à l’utilisateur qui est invité à s’y référer le plus souvent possible afin d’en prendre connaissance.</p>

        <h2 class="my-6 text-white font-semibold mx-16 text-lg">3. Description des services fournis</h2>

        <p class="my-2 text-white mx-20">Le site internet <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a> a pour objet de fournir une information concernant l’ensemble des activités de la société. <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a> s’efforce de fournir sur le site <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a> des informations aussi précises que possible. Toutefois, il ne pourra être tenu responsable des oublis, des inexactitudes et des carences dans la mise à jour, qu’elles soient de son fait ou du fait des tiers partenaires qui lui fournissent ces informations.</p>
        ...
        <p class="my-2 text-white mx-20"><a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a> ne pourra être tenu responsable des dommages directs et indirects causés au matériel de l’utilisateur, lors de l’accès au site internet <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a>, et résultant soit de l’utilisation d’un matériel ne répondant pas aux spécifications indiquées au point 4, soit de l’apparition d’un bug ou d’une incompatibilité.</p>
        ...
        <p class="my-2 text-white mx-20">pour permettre la navigation sur le Site et la gestion et la traçabilité des prestations et services commandés par l’utilisateur : données de connexion et d’utilisation du Site, facturation, historique des commandes, etc.
        pour prévenir et lutter contre la fraude informatique (spamming, hacking…) : matériel informatique utilisé pour la navigation, l’adresse IP, le mot de passe (hashé)
        pour améliorer la navigation sur le Site : données de connexion et d’utilisation
        pour mener des enquêtes de satisfaction facultatives sur <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a> : adresse email
        ...
        <p class="my-2 text-white mx-20">droit d'accès (article 15 RGPD) et de rectification (article 16 RGPD), de mise à jour, de complétude des données des Utilisateurs droit de verrouillage ou d’effacement des données des Utilisateurs à caractère personnel (article 17 du RGPD), lorsqu’elles sont inexactes, incomplètes, équivoques, périmées, ou dont la collecte, l'utilisation, la communication ou la conservation est interdite
        droit de retirer à tout moment un consentement (article 13-2c RGPD)
        droit à la limitation du traitement des données des Utilisateurs (article 18 RGPD)
        droit d’opposition au traitement des données des Utilisateurs (article 21 RGPD)
        droit à la portabilité des données que les Utilisateurs auront fournies, lorsque ces données font l’objet de traitements automatisés fondés sur leur consentement ou sur un contrat (article 20 RGPD)
        droit de définir le sort des données des Utilisateurs après leur mort et de choisir à qui <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a> devra communiquer (ou non) ses données à un tiers qu’ils aura préalablement désigné
        Dès que <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a> a connaissance du décès d’un Utilisateur et à défaut d’instructions de sa part, <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a> s’engage à détruire ses données, sauf si leur conservation s’avère nécessaire à des fins probatoires ou pour répondre à une obligation légale.</p>

        <p class="my-2 text-white mx-20">Si l’Utilisateur souhaite savoir comment <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a> utilise ses Données Personnelles, demander à les rectifier ou s’oppose à leur traitement, l’Utilisateur peut contacter <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a> par écrit aux coordonnées suivantes :</p>

        <p class="my-2 text-white mx-20">Département MMi – DPO, Ludovic Faye
        4, place Tharradin 25 200 Montbéliard.
        Tél. +33 (0)3 81 99 47 34
        Mail: dut-mmi-montbeliard@univ-fcomte.fr</p>

        <p class="my-2 text-white mx-20">Dans ce cas, l’Utilisateur doit indiquer les Données Personnelles qu’il souhaiterait que <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a> corrige, mette à jour ou supprime, en s’identifiant précisément avec une copie d’une pièce d’identité (carte d’identité ou passeport).</p>
        ...
        <p class="my-2 text-white mx-20"><a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a> s’engage à prendre toutes les précautions nécessaires afin de préserver la sécurité des Informations et notamment qu’elles ne soient pas communiquées à des personnes non autorisées. Cependant, si un incident impactant l’intégrité ou la confidentialité des Informations du Client est portée à la connaissance de <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a>, celle-ci devra dans les meilleurs délais informer le Client et lui communiquer les mesures de corrections prises. Par ailleurs <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a> ne collecte aucune « données sensibles ».</p>

        <p class="my-2 text-white mx-20">Les Données Personnelles de l’Utilisateur peuvent être traitées par des filiales de <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a> et des sous-traitants (prestataires de services), exclusivement afin de réaliser les finalités de la présente politique.</p>
        ...
        <p class="my-2 text-white mx-20">Aucune information personnelle de l'utilisateur du site <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a> n'est publiée à l'insu de l'utilisateur, échangée, transférée, cédée ou vendue sur un support quelconque à des tiers. Seule l'hypothèse du rachat de <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a> et de ses droits permettrait la transmission des dites informations à l'éventuel acquéreur qui serait à son tour tenu de la même obligation de conservation et de modification des données vis à vis de l'utilisateur du site <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a>.</p>

        <p class="my-2 text-white mx-20"><strong>Sécurité</strong></p>
        <p class="my-2 text-white mx-20">Pour assurer la sécurité et la confidentialité des Données Personnelles et des Données Personnelles de Santé, <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a> utilise des réseaux protégés par des dispositifs standards tels que par pare-feu, la pseudonymisation, l’encryption et mot de passe.</p>
        ...
        <p class="my-2 text-white mx-20"><a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a> est susceptible de traiter les informations de l’Utilisateur concernant sa visite du Site, telles que les pages consultées, les recherches effectuées. Ces informations permettent à <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a> d’améliorer le contenu du Site, de la navigation de l’Utilisateur.</p>

        <p class="my-2 text-white mx-20">Les Cookies facilitant la navigation et/ou la fourniture des services proposés par le Site, l’Utilisateur peut configurer son navigateur pour qu’il lui permette de décider s’il souhaite ou non les accepter de manière à ce que des Cookies soient enregistrés dans le terminal ou, au contraire, qu’ils soient rejetés, soit systématiquement, soit selon leur émetteur. L’Utilisateur peut également configurer son logiciel de navigation de manière à ce que l’acceptation ou le refus des Cookies lui soient proposés ponctuellement, avant qu’un Cookie soit susceptible d’être enregistré dans son terminal. <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a> informe l’Utilisateur que, dans ce cas, il se peut que les fonctionnalités de son logiciel de navigation ne soient pas toutes disponibles.</p>

        <p class="my-2 text-white mx-20">Si l’Utilisateur refuse l’enregistrement de Cookies dans son terminal ou son navigateur, ou si l’Utilisateur supprime ceux qui y sont enregistrés, l’Utilisateur est informé que sa navigation et son expérience sur le Site peuvent être limitées. Cela pourrait également être le cas lorsque <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a> ou l’un de ses prestataires ne peut pas reconnaître, à des fins de compatibilité technique, le type de navigateur utilisé par le terminal, les paramètres de langue et d’affichage ou le pays depuis lequel le terminal semble connecté à Internet.</p>

        <p class="my-2 text-white mx-20">Le cas échéant, <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a> décline toute responsabilité pour les conséquences liées au fonctionnement dégradé du Site et des services éventuellement proposés par <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a>, résultant (i) du refus de Cookies par l’Utilisateur (ii) de l’impossibilité pour <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a> d’enregistrer ou de consulter les Cookies nécessaires à leur fonctionnement du fait du choix de l’Utilisateur. Pour la gestion des Cookies et des choix de l’Utilisateur, la configuration de chaque navigateur est différente. Elle est décrite dans le menu d’aide du navigateur, qui permettra de savoir de quelle manière l’Utilisateur peut modifier ses souhaits en matière de Cookies.</p>

        <p class="my-2 text-white mx-20">À tout moment, l’Utilisateur peut faire le choix d’exprimer et de modifier ses souhaits en matière de Cookies. <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a> pourra en outre faire appel aux services de prestataires externes pour l’aider à recueillir et traiter les informations décrites dans cette section.</p>

        <p class="my-2 text-white mx-20">Enfin, en cliquant sur les icônes dédiées aux réseaux sociaux Twitter, Facebook, Linkedin et Google Plus figurant sur le Site de <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a> ou dans son application mobile et si l’Utilisateur a accepté le dépôt de cookies en poursuivant sa navigation sur le Site Internet ou l’application mobile de <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a>, Twitter, Facebook, Linkedin et Google Plus peuvent également déposer des cookies sur vos terminaux (ordinateur, tablette, téléphone portable).</p>
        ...
        <p class="my-2 text-white mx-20">Ces balises sont placées à la fois dans les publicités en ligne permettant aux internautes d’accéder au Site, et sur les différentes pages de celui-ci.</p>

        <p class="my-2 text-white mx-20">Cette technologie permet à <a class="underline" href="https://Lets-draw.daboub.fr">https://Lets-draw.daboub.fr</a> d’évaluer les réponses des visiteurs face au Site et l’efficacité de ses actions (par exemple, le nombre de fois où une page est ouverte et les informations consultées), ainsi que l’utilisation de ce Site par l’Utilisateur.</p>
