<template>
    <main class="bg-bleu">
        <div class="flex md:mx-10 py-20 md:gap-10 gap-5 mx-5">
            <h1 class="text-white md:text-5xl text-xl  leading-tight lg:mr-40 mr-5">Enfants & Artiste, présentez votre coup de pinceau, partagez votre talent sur Let’s Draw</h1>
        ...
        <div class="flex mx-auto content-center text-center justify-center lg:gap-52 gap-3  md:text-xl text-base ">
           <RouterLink class="bg-bleufonce rounded-full text-white  md:px-8 px-4 py-4" to="/choixArtiste">Envoyer mon dessin</RouterLink>
           <RouterLink class="bg-bleufonce rounded-full text-white  md:px-8 px-4 py-4" to="/Inscription">Faire un dessin</RouterLink>
        </div>
